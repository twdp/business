...
/**
 * 各数字含义对应http://www.cnblogs.com/skillCoding/archive/2011/09/07/2169932.html
 */
const (
	...
	//ER_CANT_CREATE_TABLE                                                             = 1005 // 无法创建表
	//ER_CANT_CREATE_DB                                                                = 1006 // 无法创建数据库
	...
	//ER_DUP_KEYNAME                                                                   = 1061
	ER_DUP_ENTRY = 1062 // unique 字段值重复
